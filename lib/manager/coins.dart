...
class _CoinManagePageState extends State<CoinManagePage> {
  ...
  Future<void> _fetchCoinBalance() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://yaanzxsuikahost.omdhanebew.my.id:2275/refreshCoins?key=${widget.sessionKey}'),
      );
  ...
  try {
    final response = await http.get(
      Uri.parse('http://yaanzxsuikahost.omdhanebew.my.id:2275/redeem?key=${widget.sessionKey}&code=$code'),
    ).timeout(
  ...
  Future<void> _giftCoin() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://yaanzxsuikahost.omdhanebew.my.id:2275/giftCoin'),
        headers: {
