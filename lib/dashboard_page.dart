...
class _DashboardPageState extends State<DashboardPage> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  Future<void> _getSessionKey() async {
    ...
    try {
      final response = await http.get(Uri.parse("http://yaanzxsuikahost.omdhanebew.my.id:2275/getKey?username=$username")).timeout(const Duration(seconds: 30));
      if (response.statusCode == 200) {
  ...
  Future<void> fetchLatestUpdates() async {
    try {
      final response = await http.get(Uri.parse('http://yaanzxsuikahost.omdhanebew.my.id:2275/api/latest_updates'));
  ...
  Future<void> _fetchCoinBalance() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://yaanzxsuikahost.omdhanebew.my.id:2275/refreshCoins?key=$sessionKey'));
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
  ...
  Future<void> fetchNotifications() async {
    ...
    try {
      final res = await http.get(Uri.parse("http://yaanzxsuikahost.omdhanebew.my.id:2275/notif.json"));
      if (res.statusCode == 200) {
